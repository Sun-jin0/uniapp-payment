...
const config = {
  ...
  tagStyle: {
    ...
    pre: 'font-family:monospace;white-space:pre-wrap;word-wrap:break-word;word-break:break-all;background-color:#f0f9f8;color:#000000;padding:8px 12px;border-radius:8rpx;border:1rpx solid #5FBDB5;line-height:1.4;margin:0;',
